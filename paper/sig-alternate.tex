...
\ref{unit-test}, the invocation \textit{inv.calcTax()} links the surrounding unit test (\textit{shouldCalculateTaxes()}) to 
...
We then used the formula. In Figures \ref{fig:metricminer-aj}, \ref{fig:tubaina-aj}, and
